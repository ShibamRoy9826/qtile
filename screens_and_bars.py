...
#### Bar ==============================================================================
decor=[RectDecoration(colour="#11111b", radius=10, filled=True, padding_y=6, group=True)]
...
mybar = bar.Bar(
    [
        ...
        widget.ThermalSensor(
            threshold=80, fontsize=15, update_interval=5, foreground=fg,
            format="󰔏 {temp:.1f}{unit}",padding=20,
            decorations=decor
        ),
        widget.Memory(
